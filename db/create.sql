...
insert into products (name, description, code, price,maten,ratings_id) values ('Look-a-like skincare', 'Wil jij dezelfde skincare als de kardashians dan is dit pakket voor jou, dermatologisch getest, voor alle huidtypes beschikbaar.', '452662523-7', 25,1,2);
 insert into products (name, description, code, price,maten,ratings_id) values ('Look-a-like make-up', 'Wil jij dezelfde make-up als de kardashians dan is dit pakket voor jou, dermatologisch getest, voor alle huidtypes beschikbaar.', '492762523-7', 20,1,3); 
insert into products (name, description, code, price,maten,ratings_id) values ('Look-a-like kendall', 'Wil jij dezelfde outfit als Kendall Jenner dan is dit pakket voor jou, echt door kendall gedragen, omdat dit door Kendall is gedragen is het dus ook maar in 1 maat beschikbaar.', '92662623-7', 30,1,1);
  insert into products (name, description, code, price,maten,ratings_id) values ('Look-a-like Kylie', 'Wil jij dezelfde outfit als Kylie Jenner dan is dit pakket voor jou, echt door kylie gedragen en omdat dit door Kylie is gedragen is het dus ook maar in 1 maat beschikbaar.', '49262623-7', 35,1,1);
  insert into products (name, description, code, price,maten,ratings_id) values ('Look-a-like Blair', 'Wil jij dezelfde outfit als blair waldorf dan is dit pakket voor jou, omdat deze outfit moeilijk verkrijgbaar is, is het maar in 2 maten beschikbaar.', '49662623-7', 50,2,1);
 insert into products (name, description, code, price,maten,ratings_id) values ('Look-a-like Khloe', 'Wil jij dezelfde outfit als Khloe Kardashian dan is dit pakket voor jou, echt door khloe gedragen, omdat dit door Khloe is gedragen is het dus ook maar in 1 maat beschikbaar.', '49266263-7', 45,1,1); 
  insert into products (name, description, code, price,maten,ratings_id) values ('Look-a-like kris', 'Wil jij dezelfde outfit als Kris Jenner dan is dit pakket voor jou, echt door kris gedragen, omdat dit door Kris is gedragen is het dus ook maar in 1 maat beschikbaar.', '492662623-8', 40,1,1);
